...
var ImageOverlay = function (_React$Component) {
    ...
    function ImageOverlay(props) {
        ...
        _this.addListenScroll = function () {
            window.addEventListener("scroll", _this.handleScroll, true);
        };

        _this.removeListenScroll = function () {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactTransitionGroup.CSSTransitionGroup,
                    {
                        ...
                        transitionEnterTimeout: _config.animateDuration,
                        transitionLeaveTimeout: _config.animateDuration,
                        transitionName: {
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement('img', {
                            ...
                            style: (0, _stateStyle.imageStyle)(zmageId, show, zoom, zoomMargin, coverNodeRef)
                        })
                    )
                ),
...
exports.bgOverlayStyle = exports.imageStyle = exports.imageWrapperStyle = exports.altStyle = exports.pagesStyle = exports.nextStyle = exports.prevStyle = exports.lineR = exports.lineL = exports.zoomStyle = undefined;
...
var nextStyle = exports.nextStyle = function nextStyle(show) {
  ...
  // 页面中心点位置
  var centerPosition = "translate3d(0, 0, 0)";
  // 封面位置 (如果当前为第一页，则返回封面位置，否则向上隐藏)
  var coverPosition = current === 0 ? "translate3d(0, 0, 0)" : "translate3d(0, -100vh, 0)";
  if (coverNodeRef) {
    var coverNodeRect = coverNodeRef.getBoundingClientRect();
    coverPosition = current === 0 ? "translate3d(calc(-50vw + " + (coverNodeRect.left + coverNodeRect.width / 2) + "px), calc(-50vh + " + (coverNodeRect.top + coverNodeRect.height / 2) + "px), 0)" : "translate3d(0, -80vh, 0)";
  }
  return show ? {
...
var imageStyle = exports.imageStyle = function imageStyle(zmageId, show, zoom, zoomMargin, coverNodeRef) {

  var nodeRef = coverNodeRef || document.getElementById(zmageId);
  var coverNodeStyle = {},
      opacity = 0;
  var coverScale = 0,
      fitScale = 0,
  ...
  if (nodeRef) {
    ...
    fitScale = (0, _utils.calcFitScale)(nodeRef, zoomMargin);
  }
...
// React Libs
var animateDuration = exports.animateDuration = 400;
// 动画曲线 ( img/index.less )
...
var calcFitScale = exports.calcFitScale = function calcFitScale(nodeRef, margin) {
	...
	var naturalWidth = nodeRef.naturalWidth + margin,
	    naturalHeight = nodeRef.naturalHeight + margin;
